...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-12 02:33`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0490e50d-9a7b-425b-8936-6e37b495a4d9.git
$ cd 0490e50d-9a7b-425b-8936-6e37b495a4d9
```
